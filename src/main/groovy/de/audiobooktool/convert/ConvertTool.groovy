...
class ConvertTool {
  public static void main(String[] args) {
    ...
    ConversionParameterObj conversionParameterObj = new ConversionParameterObj(
    ...
    conversionParameterObj.determineFileOutputBase()
    ...
    switch (cmdOpt) {
      case 'splitToMP3':
        conversionParameterObj.outputFormat = OutputFormatEnum.MP3
        command = new SplitToChapterCommand(conversionParameterObj)
        break
      case 'splitToM4A':
        conversionParameterObj.outputFormat = OutputFormatEnum.M4A
        command = new SplitToChapterCommand(conversionParameterObj)
        break
      case 'joinToM4A':
        conversionParameterObj.outputFormat = OutputFormatEnum.M4B
        command = new MergeToM4BCommand(conversionParameterObj)
        break
      default:
    ...
    log.info("$conversionParameterObj")
